    ...
    <header class="s-header">
        ...
        <div class="header-logo">
            <a class="site-logo" href="index.html">
                <img src="images/logo.eu.png" alt="Homepage">
            </a>
        </div>
        ...
        <nav class="header-nav">
            ...
            <div class="header-nav__content">
                ...
                <!-- <p>Looking forward to contact me? <a href='#'>sohaib[at]sohaib[dot]eu. </a> Based in Europe, made Globally.</p> -->
    ...
    <section id="contact" class="s-contact">
        ...
        <div class="row contact-content" data-aos="fade-up">
            ...
            <div class="contact-primary">
                ...
                <h3 class="h6">Leave a message</h3>
            ...
            <div class="contact-secondary">
                <div class="contact-info">
                    ...
                    <div class="cinfo">
                        <h5>Via email</h5>
                        <p>
                            info[at]sohaib[dot]eu<br>
                            sohaib[at]sohaib[dot]eu
                        </p>
                    </div>
